...
var path = "/images/flame.png"; // URL of your image
...
function initTrail() { // prepares the script
  ...
  for (i = 0; i < images.length; i++) { // make divs for IE and layers for Navigator
    document.write('<div id="obj' + i + '" style="position: absolute; z-Index: 100; height: 50px; width: 50px"><img src="' + images[i].src + '"></div>')
  }
  trail()
}
